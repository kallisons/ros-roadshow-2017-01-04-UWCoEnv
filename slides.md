...
- Bolnick sent the original R code to Wilson, and after a couple of back-and-forth emails they found an error in the Mantel Test analysis.  When analyzed correctly, **there was no correlation between morphology and diet**. Bolnick sent a retraction request to the journal. 
